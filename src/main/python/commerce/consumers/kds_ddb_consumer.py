...
pre_shard_it = kinesis.get_shard_iterator(StreamName="aws-certificate-log-stream", ShardId=shard_id, ShardIteratorType="LATEST")
shard_it = pre_shard_it["ShardIterator"]

# DynamoDB setup
dynamodb = boto3.resource('dynamodb', 'us-east-1')
table = dynamodb.Table('cadabara-orders')
